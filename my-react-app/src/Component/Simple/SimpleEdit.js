                    ...
                    <Row gutter={24}>
                        <Col span={12}>
                            ...
                            <FormItem label="行为类型" {...formItemLayout}>
                                <Selects SelectKey='Action'  defaultValue={TableValue.ActionType} handleChange={this.props.handleChange}></Selects>
                            </FormItem>
                        </Col>
                        <Col span={12}>
                            ...
                            <FormItem label="所属模块" {...formItemLayout}>
                                <Selects SelectKey='Module'  defaultValue={TableValue.Module} handleChange={this.props.handleChange}></Selects>
                            </FormItem>
                        </Col>
                    </Row>
