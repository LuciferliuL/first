                        ...
                        <Row gutter={24}>
                            <Col span={12}>
                                ...
                                <FormItem label="条件控制程序集" {...formItemLayout}>
                                    <Input value={TableValue.DQueryParamAssembly} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                                <FormItem label="主控件程序集" {...formItemLayout}>
                                    <Input value={TableValue.DQueryMasterAssembly} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                                <FormItem label="从控件程序集" {...formItemLayout}>
                                    <Input value={TableValue.DQuerySlaveAssembly} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                                ...
                                <FormItem label="作者" {...formItemLayout}>
                                    <Input value={TableValue.Author} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                            </Col>
                            <Col span={12}>
                                <FormItem label="窗口名称" {...formItemLayout}>
                                    <Input value={TableValue.DQueryCaption} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                                <FormItem label="条件控制命名" {...formItemLayout}>
                                    <Input value={TableValue.DQueryParamFullName} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                                <FormItem label="主控件命名" {...formItemLayout}>
                                    <Input value={TableValue.DQueryMasterFullName} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
                                <FormItem label="从控件命名" {...formItemLayout}>
                                    <Input value={TableValue.DQuerySlaveFullName} onChange={this.handleChange.bind(this, 'BillTypeCode')}></Input>
                                </FormItem>
